...
export const SPLUNK_SDK_REFERENCE: SplunkSymbolRef[] = [
  {
    ...
    description: 'Base class for Splunk modular inputs. Override get_scheme, validate_input, and stream_events.',
  ...
  {
    symbol: 'BaseModInput',
    signature: 'class BaseModInput(app_name: str, input_name: str, use_single_instance: bool = False)',
  ...
  },
  {
    ...
    signature: 'new_event(data: str, source: str | None = None, sourcetype: str | None = None, index: str | None = None)',
    module: 'splunktaucclib.modinput_wrapper',
    category: 'splunktaucclib',
