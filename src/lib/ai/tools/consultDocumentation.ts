...
export const consultDocumentation: Tool = {
  ...
  description: 'Search technical documentation for Splunk/UCC/Python details. Uses local FlexSearch index first (specs/docs/examples), then optional external context service.',
  parameters: {
    type: 'object',
    properties: {
      query: { type: 'string', description: 'The search query (e.g., "how to configure oauth in ucc")' }
    },
    required: ['query']
  },
