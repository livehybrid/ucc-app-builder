...
## Advanced Setup: AI & Context Integration

To enable the AI capabilities (including Context7/RAG):

1. Create a `.env` file in the root directory.
2. Add the following keys:

```bash
# For AI Chat features (optional - uses OpenRouter)
OPENROUTER_API_KEY=sk-or-v1-xxxxxxxx

# For Context7/RAG Integration (optional)
CONTEXT_API_URL=https://your-context7-instance.upstash.io/query
CONTEXT_API_KEY=your-context-api-key

# Local docs/specs/examples index (enabled by default)
UCC_ENABLE_LOCAL_DOCS_INDEX=true

# Optional path to add-on example corpus for local indexing
# (relative to apps/ucc-app-builder or absolute path)
UCC_EXAMPLES_DIR=../../apps/addonfactory-ucc-generator
UCC_ENABLE_EXAMPLES_INDEX=true

# Optional testing-only capabilities (default: disabled)
# Keep these OFF in hosted production deployments.
UCC_ENABLE_DOCKER_TOOLS=false
UCC_ENABLE_BROWSER_CHECK=false
```
